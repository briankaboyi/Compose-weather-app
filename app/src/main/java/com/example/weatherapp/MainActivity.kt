...
fun WeatherScreen() {
    ...
    val apiKey = "9af65ae8c3aedb41c726c94efefe9764"

    Box(
        modifier = Modifier
            .fillMaxSize()
            .paint(painterResource(id = R.drawable.weather), contentScale = ContentScale.FillBounds)
    ) {
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            OutlinedTextField(
                ...
                colors = TextFieldDefaults.colors(
                    ...
                    focusedLabelColor = DarkBlueJC, focusedTextColor = Color.Black, focusedPrefixColor =  Color.Black
                )
            ...
            weatherData?.let {
                ...
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceEvenly) {
                    ...
                    WeatherCard(label = "Temperature", value = it.weather[0].description, icon = Icons.Default.Info)
                }
            }
        }
    }
